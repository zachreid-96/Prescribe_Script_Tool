    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.file_command_list = [
                cls._instance.line_mode_60_command,
...
def update():
    print("")
    print("Or visit the following link to check for an updated version.")
    print("https://github.com/zachreid-96/Prescribe_Script_Tool")
    print("")
